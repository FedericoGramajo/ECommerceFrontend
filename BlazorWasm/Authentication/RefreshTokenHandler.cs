...
{
    public class RefreshTokenHandler(ITokenService tokenService, IAuthenticationService authenticationService, IHttpClientHelper httpClient) : DelegatingHandler
    {
